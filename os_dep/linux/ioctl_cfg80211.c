...
#elif (LINUX_VERSION_CODE != KERNEL_VERSION(5, 15, 148) || defined(CONFIG_MLD_KERNEL_PATCH) || (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 19, 2)))
				     ...
				     struct vif_params *params)
{
	...
	case NL80211_IFTYPE_P2P_GO:
		...
		break;
#endif /* defined(CONFIG_P2P) && ((LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 37))  ) */
